...
export default function OwnerDashboardHome() {
    ...
    return (
        <div className="w-full bg-[#131313] text-[#e5e2e1] font-sans antialiased pt-6 sm:pt-8 pb-16">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6 sm:space-y-8">
                ...
                {/* Hero Banner with Themed High-Definition Visual & Dark Vignette Filter */}
                <div className="relative w-full h-64 sm:h-80 bg-[#0e0e0e] border border-[#353535] rounded-none overflow-hidden shadow-2xl flex flex-col justify-end p-6 sm:p-10">
                    {/* Crystal clear background photography matching Ethereal Obsidian theme */}
                    <div 
                        className="absolute inset-0 bg-cover bg-center" 
                        style={{ backgroundImage: `url('https://images.unsplash.com/photo-1564013799919-ab600027ffc6?auto=format&fit=crop&w=1600&q=90')` }}
                    ></div>
                    {/* Professional dark filter scrim for absolute text contrast and readability */}
                    ...
                    <div className="relative z-10 space-y-2 max-w-2xl">
                        ...
                        <h2 className="text-xl sm:text-3xl font-serif font-bold uppercase text-[#e5e2e1] tracking-tight">
                            Incoming Booking Stream
                        </h2>
                        <p className="text-xs sm:text-sm text-[#c4c7c7] font-sans leading-relaxed">
                            Manage incoming tenant reservations, verify property stay windows, and authorize or decline lease requests across your portfolio.
                        </p>
                    </div>
                </div>
                        ...
                        {bookings.map((booking) => {
                            ...
                            return (
                                <div 
                                    ...
                                    className="bg-[#1c1b1b] border border-[#353535] hover:border-[#5ddda1] p-4 sm:p-6 rounded-none shadow-2xl flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6 transition-all duration-300 cursor-pointer group"
                                >
                                    {/* Left Side: Property Thumbnail & Metadata */}
                                    <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center w-full lg:w-auto">
                                        <div className="w-full sm:w-28 h-36 sm:h-28 bg-[#0e0e0e] rounded-none border border-[#444748] overflow-hidden shrink-0 relative">
                                            {propertyImage ? (
                                                <img
                                                    src={propertyImage}
                                        ...
                                        <div className="space-y-1.5 flex-1">
                                            <div className="flex flex-wrap items-center gap-2">
                                                ...
                                                <span className="text-[9px] text-[#8e9192] font-mono">ID: {bId.slice(-6)}</span>
                                            </div>

                                            <h4 className="text-sm sm:text-base font-serif font-bold uppercase text-[#e5e2e1] group-hover:text-[#5ddda1] transition-colors line-clamp-1">
                                    ...
                                    {/* Right Side: Actions */}
                                    <div className="flex flex-wrap items-center gap-3 w-full lg:w-auto justify-end border-t lg:border-t-0 pt-4 lg:pt-0 border-[#353535]">
                                        {status === "pending" && (
                                            <>
                                                <button
                                                    onClick={(e) => handleAccept(e, bId)}
                                                    disabled={isActionBusy}
                                                    className="flex-1 sm:flex-none px-5 py-2.5 bg-[#5ddda1] hover:bg-[#08a56e] text-[#003823] text-[10px] font-bold uppercase tracking-widest rounded-none transition-all cursor-pointer disabled:opacity-40 shadow-md"
                                                >
                                                ...
                                                <button
                                                    ...
                                                    disabled={isActionBusy}
                                                    className="flex-1 sm:flex-none px-5 py-2.5 bg-[#1c1b1b] hover:bg-[#ffb4ab] text-[#ffb4ab] hover:text-[#380007] border border-[#444748] hover:border-[#ffb4ab] text-[10px] font-bold uppercase tracking-widest rounded-none transition-all cursor-pointer disabled:opacity-40 shadow-md"
                                                >
                                                    Reject
                                                </button>
                                            </>
